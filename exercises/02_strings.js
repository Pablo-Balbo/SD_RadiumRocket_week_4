...
const longString = 'welcome to the Radium Rocket Software Developer course';
...
const seekAndDestroyString = 'We are scanning the scene in the city tonight';
...
const nerdString = 'You are the css of my html';
...
const vilasMovie = 'you will be what you should be of you will be nothing';
...
const theBeatles = 'Yesterday, all my troubles seemed so far away';
...
const biggestBrother = 'I am the biggest brother';
